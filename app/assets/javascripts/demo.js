...
$(function() {
  ...
  $(".mailbox-form").on("ajax:complete", function(e, xhr, settings, exception) {
    ...
    rows = _.map(xhr.responseJSON, function(element, index, list) { return '<tr><td class = "col-md-2">' + element["sender"] + '</td><td class = "col-md-2"><a class = "mail" data-guid = "' + element["uid"]  + '">' + element["subject"] + '</a></td><td><a href = "#">' + element["has_attachments"] + '</a></td></tr>' } ).join("\r\n")
